# Failure Analysis: 20260408_222855_random_cabinet_experiment
...
- `ACQUIRE_TARGET`: `1.272s`
- `ARM_STOW_SAFE`: `2.258s`
- `BASE_ENTER_WORKSPACE`: `2.711s`
- `LIFT_TO_BAND`: `2.210s`
- `PLAN_TO_PRE_INSERT`: `3.098s`
...
- Total parsed stage time: `9.916s`
...
- Total parsed stage time: `13.235s`
