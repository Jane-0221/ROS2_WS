# Failure Analysis: 20260409_003451_random_cabinet_experiment
...
- `INSERT_AND_SUCTION`: `10.524s`
- `LIFT_TO_BAND`: `2.211s`
- `PLAN_TO_PRE_INSERT`: `2.908s`
- `SELECT_PRE_INSERT`: `0.508s`
...
- Total parsed stage time: `62.642s`
