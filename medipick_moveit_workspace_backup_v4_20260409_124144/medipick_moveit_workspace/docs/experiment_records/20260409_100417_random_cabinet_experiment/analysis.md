# Failure Analysis: 20260409_100417_random_cabinet_experiment
...
- `INSERT_AND_SUCTION`: `0.238s`
- `LIFT_TO_BAND`: `2.215s`
- `PLAN_TO_PRE_INSERT`: `2.272s`
- `SELECT_PRE_INSERT`: `0.416s`
...
- Total parsed stage time: `16.294s`
